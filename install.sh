...
#SYSTEM_FILTER=
#STATUS_FILTER=
#COPILOT_WIDGET_TITLE=GitHub Copilot
#COPILOT_CACHE_TTL=300
#COPILOT_CREDITS=1500
#COPILOT_CREDIT_VALUE=0.01
#OPENROUTER_WIDGET_TITLE=OpenRouter Credits
...
EOF
  ...
  info "Existing .env found — not overwritten"
fi
